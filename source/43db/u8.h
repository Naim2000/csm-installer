...
inline U8Node *u8GetNodeByOffset(U8Context *ctx, u32 offset)
{
    u32 node_idx = 0;
    if (!ctx || !ctx->nodes || !__builtin_is_aligned(offset, sizeof(U8Node)) || (node_idx = (u32)(offset / sizeof(U8Node))) >= ctx->node_count) return NULL;
